...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        elderlyArrayList.add(new Elderly("chang","홍길동","010-0000-0000","서울")) ;
        elderlyArrayList.add(new Elderly("min","임꺽정","010-0000-0000","서울")) ;
        elderlyArrayList.add(new Elderly("gogo","장길산","010-0000-0000","서울")) ;
        elderlyArrayList.add(new Elderly("gugu","안철수","010-0000-0000","서울")) ;
        elderlyArrayList.add(new Elderly("hogho","배철수","010-0000-0000","서울")) ;
